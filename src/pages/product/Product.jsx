...
function Product() {
    ...
    const { data: product, isLoading, totalPage } = useQuery("product", search, page, limit, refetch)
   
    const { remove, isLoading: isDeleting } = useCollection("product")
        ...
        <div>
            <div className='flex justify-between mb-4'>
                ...
                <div>
                    ...
                    <Link to="/product/create" className='font-bold btn btn-neutral btn-outline'>
                        + New
                    </Link>
                    ...
                    <table className="table">
                        ...
                        <thead >
                            <tr >
                                ...
                                <th className='font-bold'>costPrice</th>
                                <th className='font-bold'>salePrice</th>
                                <th className='font-bold'>currentStock</th>
                                ...
                                <tbody>
                                    {
                                        product?.map((item, index) => (
                                            <tr key={index} className="hover:bg-base-300">
                                                <td>
                                                    <img
                                                        src={`http://localhost:8000/upload/${item?.imageUrl}`}
                                                        alt=""
                                                        width={50}
                                                    />
                                                </td>
                                                ...
                                                <td className='space-x-2'>
                                                    ...
                                                    <Link to={`/product/edit/${item._id}`} className=" bg-blue-700 text-white p-2 rounded font-bold cursor-pointer">Edit</Link>
