...
import { useAddPaymentSale } from '../../hook/useAddPaymentSale'
...
function SalePaymentModal({ open, onClose, editId }) {
   ...
   console.log(data)
    const {addPayment,isLoading:updating}=useAddPaymentSale()
            ...
            <Modal open={open} onClose={closeModal} title={"update Paymentt Purchase Status"}>
                ...
                <form action="" onSubmit={handleSubmit}>
                    <div className='mt-5 mb-2'>
                        ...
                        <input onChange={(e) => setPaidAmount(Number(e.target.value))} value={paidAmount} type="number" className='w-full input validator' placeholder='Enter Paid Amount' min={0}  />
