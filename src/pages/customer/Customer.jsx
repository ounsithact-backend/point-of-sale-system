...
function Customer() {
    ...
    const { data: customer, isLoading, totalPage } = useQuery("customer", search, page, limit, refetch)
    const { remove, isLoading: isDeleting } = useCollection("customer")
        ...
        <div>
            <div className='flex justify-between mb-4'>
                ...
                <div>
                    ...
                    <Link to="/customer/create" className='font-bold btn btn-neutral btn-outline'>
                        + New
                    </Link>
            ...
            <div className='border-3 p-4 rounded-md border-red-400'>
                ...
                <div className="overflow-x-auto">
                    <table className="table">
                        ...
                        {
                            customer?.length == 0 && isLoading == false && (
                                <tbody>
                                    <tr>
                                        <td colSpan={6}>
                                        ...
                                        customer?.map((item, index) => (
                                            <tr key={index} className="hover:bg-base-300">
                                                ...
                                                <td className='space-x-2'>
                                                    ...
                                                    <Link to={`/customer/edit/${item._id}`} className=" bg-blue-700 text-white p-2 rounded font-bold cursor-pointer">Edit</Link>
