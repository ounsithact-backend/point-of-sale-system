...
function Category() {
    ...
    const { data:category, isLoading, totalPage } = useQuery("category", search, page, limit, refetch)
    const { remove, isLoading: isDeleting } = useCollection("category")
        ...
        <div>
            <div className='flex justify-between mb-4'>
                ...
                <div>
                    ...
                    <Link  to="/category/create" className='font-bold btn btn-neutral btn-outline'>
                        + New
                    </Link>
            ...
            <div className='border-3 p-4 rounded-md border-red-400'>
                ...
                <div className="overflow-x-auto">
                    <table className="table">
                        ...
                        {
                            category?.length == 0 && isLoading == false && (
                                <tbody>
                                    <tr>
                                        <td colSpan={4}>
                                        ...
                                        category?.map((item, index) => (
                                            <tr key={index} className="hover:bg-base-300">
                                                ...
                                                <td className='space-x-2'>
                                                    ...
                                                    <Link to={`/category/edit/${item._id}`} className=" bg-blue-700 text-white p-2 rounded font-bold cursor-pointer">Edit</Link>
