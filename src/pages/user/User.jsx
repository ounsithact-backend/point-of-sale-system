...
function User() {
    ...
    const { data:user, isLoading, totalPage } = useQuery("user", search, page, limit, refetch)
   
    const { remove, isLoading: isDeleting } = useCollection("user")
        ...
        <div>
            <div className='flex justify-between mb-4'>
                ...
                <div>
                    ...
                    <Link  to="/user/create" className='font-bold btn btn-neutral btn-outline'>
                        + New
                    </Link>
                                        ...
                                        user?.map((item, index) => (
                                            <tr key={index} className="hover:bg-base-300">
                                                ...
                                                <td className='space-x-2'>
                                                    ...
                                                    <Link to={`/user/edit/${item._id}`} className=" bg-blue-700 text-white p-2 rounded font-bold cursor-pointer">Edit</Link>
