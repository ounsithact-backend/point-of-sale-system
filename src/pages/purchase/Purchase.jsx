...
function Purchase() {
    ...
    const { data: purchase, isLoading, totalPage } = useQuery("purchase", search, page, limit, refetch)
                    ...
                    <table className="table">
                        ...
                        <thead >
                            <tr >
                                ...
                                <th className='font-bold'>Purcase By</th>
                                ...
                                <th className='font-bold '>Purchase Status</th>
                                <th className='font-bold'>Purchase Date</th>
                                <th className='font-bold'>Actions</th>

                            </tr>
                        </thead>
                        {
                            purchase?.length == 0 && isLoading == false && (
                                <tbody>
                                    <tr>
                                        <td colSpan={11}>
                                ...
                                <tbody>
                                    {
                                        purchase?.map((item, index) => (
                                            <tr key={index} className="hover:bg-base-300">
                                                ...
                                                <td>
                                                    <span
                                                        className={`font-medium rounded p-2 me-2 text-whit
                                                          ${item.purchaseStatus === "received" && "bg-green-500"}
                                                           ${item.purchaseStatus === "ordered" && "bg-blue-500"}
                                                           ${item.purchaseStatus === "pending" && "bg-yellow-500"}
                                                           ${item.purchaseStatus === "cancel" && "bg-red-500"}
                                                          `
                                                ...
                                                <td className='space-x-2'>
                                                    ...
                                                    <button
                                                        ...
                                                        className={`${item.purchaseStatus === "received" ? "text-gray-500 cursor-not-allowed" : "text-green-500"}`}>
                                                        <TbTruckDelivery />
                                                    </button>
                                                </td>
                                            </tr>
